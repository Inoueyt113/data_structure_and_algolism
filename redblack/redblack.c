...
void delfix(Node *r, dir direction)
{
    ...
    if (direction == dirleft)
    {
        ...
        else if (b_color == 0 && c_color == 1 && d_color == 1)
        {
            ...
            // 2パターン目
            else if (d_num == 2 || c_num == 0 && d_num == 0)
            {
                puts("del 2pattern");
                if (haveparent == 0)
                {
        ...
        else if (b_color == 1 && c_color == 0 && d_color == 0)
        {
            puts("del 5pettern");
            if (haveparent == 0)
            {
...
Node *deleteNode(Node *root, int data)
{
    ...
    if (childNum == 2)
    {
        ...
        if (x->parent == NULL)
        {
            ...
            else if (c->parent != x && c->left == NULL)
                c->parent->right = NULL;
